...
2. 人物的一致性
3. 多机位拍摄并进行剪辑
除此之外，还补充了创意生成，一镜到底等能力。视频的创作大概流程是创意 -> 大纲 -> 剧情 -> 分镜 -> 演绎(特效生成) -> 剪辑 -> 创作。
AI不仅可以在每个环节辅助创作，一个大的变化是，可能不再需要人为拍摄多机位，直接由AI来接管，从创意共创，到完成创作，中间的环节全部完成了。
人类在其中的角色呢？
* 素材提供
* idea提供
* 方向、决策、评价
而普通的消费者，可能以后要在AI生产的“电子鸦片”里面杀时间了。
